...
create table inscripcion(id_inscripcion number(22) primary key, nombre
varchar2(100),telefono number(22), id_curso varchar2(50), id_forma_pago
varchar2(50),
foreign key (id_curso) references curso(id_curso));
CREATE SEQUENCE inscripcion_sec MINVALUE 1 START WITH 1 INCREMENT BY 1
NOCACHE;
