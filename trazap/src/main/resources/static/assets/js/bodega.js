$(document).ready(function(){
	...
	$('#table').bootstrapTable({ 	
	            ...
	            columns: [ {
					...
					formatter: function(value, row, index) {
						return [
							...
							"</a>  ",
							"<a class='remove' href='#' onclick='onClickEliminar(\"" + row.idBodega + "\");' title='Borrar'>",
		...
		$.ajax({
                type:"GET",
                url:"http://localhost:8080/trazap/ws/bodegas",
                dataType:"json",
