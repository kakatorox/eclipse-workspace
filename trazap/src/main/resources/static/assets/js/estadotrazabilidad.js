$(document).ready(function(){
	...
	$('#table').bootstrapTable({ 	
	            ...
	            pageList: [5, 10],
	            sortOrder: "desc",
	            sortName: "idEstadoTrazabilidad",
	            locale: "es-ES",
	            columns: [ {
	                field: 'idEstadoTrazabilidad',
	                title: 'ID Bodega',	                
	                sortable: true,
	                width: '180px'
	            },{
					...
					formatter: function(value, row, index) {
						return [
							...
							"</a>  ",
							"<a class='remove' href='#' onclick='onClickEliminar(\"" + row.idEstadoTrazabilidad + "\");' title='Borrar'>",
		...
		$.ajax({
                type:"GET",
                url:"http://localhost:8080/trazap/ws/estadoTrazabilidad",
                dataType:"json",
	...
	$("#idBtnActualizar").click(function() {
		...
		var dataProducto = {
							"idEstadoTrazabilidad":  $("#idEditar").val(),
...
function onClickEditar(row) {
	...
	$('#idEditar').val(raw.idEstadoTrazabilidad);
