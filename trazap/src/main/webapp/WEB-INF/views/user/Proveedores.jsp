      ...
      <div class="modal-body">
       <div class="form-row">
		    <div class="form-group col-md-6">
		      <label for="idRutProveedor">Rut Proveedor</label>
		      <input type="text" class="form-control" id="idRutProveedor">
		    </div>
		    <div class="form-group col-md-6">
		      <label for="idRazonSocial">Razon Social</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="form-row">
		    ...
		    <div class="form-group col-md-6">
		      <label for="idRutProveedorEditar">Rut Proveedor</label>
		      <input type="text" class="form-control" id="idRutProveedorEditar">
		    </div>
		    <div class="form-group col-md-6">
		      <label for="idRazonSocialEditar">Razon Social</label>
		      <input type="text" class="form-control" id="idRazonSocialEditar">
		    </div>	
		  </div>		
      </div>
      <div class="modal-footer">
