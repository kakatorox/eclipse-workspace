...
<script>
	let listNoti = '${listadoNoticias}';
</script>
<script src='<c:url value="assets/js/noticias.js" />'></script>
<title>Tabla de Noticiero</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-light bg-success  ">
  <a class="navbar-brand text-white" href="#">Noticias</a>
